"""P5 CQL decision-consequence collector for Kaggle and local validation."""
...
ENV_NAME = "Hopper-v5"
CHECKPOINTS = {
    0: Path("checkpoints/cql_seed0/cql_mujoco_hopper_medium-v0_seed0.d3"),
    1: Path("checkpoints/cql_seed1/cql_mujoco_hopper_medium-v0_seed1.d3"),
    2: Path("checkpoints/cql_seed2/cql_mujoco_hopper_medium-v0_seed2.d3"),
    3: Path("checkpoints/cql_seed3/cql_mujoco_hopper_medium-v0_seed3.d3"),
    4: Path("checkpoints/cql_seed4/cql_mujoco_hopper_medium-v0_seed4.d3"),
}
...
NOISE_SEED = 20260829
OUTPUT_DIR = Path("results/reliability/P5_CQL/raw")
PROTOCOL = "experiments/reliability/P5_CQL_GENERALIZATION_PROTOCOL.md"
...
def collect_seed(policy_seed, checkpoint, n_episodes, states_per_episode, status):
    ...
    output = {
        "experiment": "P5_CQL_decision_consequence_full", "status": status,
        "task": TASK, "environment": ENV_NAME, "algorithm": "CQL",
